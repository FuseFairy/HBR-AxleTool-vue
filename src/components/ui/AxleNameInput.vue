  ...
  <div class="axle-name-input-container">
    ...
    <div class="input-with-button">
      <input
        ...
        :maxlength="maxlength"
      />
      <button v-tooltip="{ content: 'Save Axle', placement: 'top' }" class="save-axle-button"  :disabled="skillStore.axleId === ''" @click="handleSaveAxle">
        <img :src="getAssetsFile('custom-icon/save.svg')" alt="Save Axle" />
      </button>
      <button v-tooltip="{ content: 'Save Axle As New', placement: 'top' }" class="save-as-axle-button" @click="handleSaveAsAxle">
